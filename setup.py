...
setup(
  name = 'colladaWT',         # How you named your package folder (MyLib)
  packages = ['colladaWT'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/charlie9578/wind-turbine-kml/archive/refs/tags/v0.1-alpha.tar.gz',    # Found under the release version on GitHub
